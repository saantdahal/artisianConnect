      ...
      <DialogContent className="sm:max-w-[600px] p-8">
        ...
        <DialogHeader className="mb-4">
          <DialogTitle className="text-2xl font-bold text-center text-teal-700">
            Welcome to Artisian Connect
          </DialogTitle>
          <DialogDescription className="text-center text-gray-500">
            Join our community to shop the latest trends and exclusive
            collections. please enter your details below.
          </DialogDescription>
        </DialogHeader>
        <Tabs
          defaultValue="signin"
          ...
          <TabsContent value="signin">
            <Form {...form}>
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white h-11 text-base"
                  disabled={isLoading}
                >
                  {isLoading ? (
